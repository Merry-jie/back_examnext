...
STACKAI_API_URL = "https://api.stack-ai.com/inference/v0/run/db36af19-8800-481f-926f-da69587b2e84/698ec3af1ecd2f4af35bac11"
STACKAI_API_KEY = "Bearer 8cabd8aa-c824-4834-b74d-e28ab8a79c1as"
...
# -------------------------------------------------------------------
# SERVICE D'ANALYSE DE DOCUMENTS (simule)
# -------------------------------------------------------------------
...
class CompactItem(BoxLayout):
    ...
    def _mark_as_read(self, result, popup):
        ...
        if item_id:
            ...
            # Attendre un peu que la BD soit mise a jour
...
# -------------------------------------------------------------------
# MODULE TERMINAL SIGMA (AVEC PLUIE BINAIRE DANS LA ZONE DE SAISIE)
# -------------------------------------------------------------------
...
"""
    ...
    def execute_command(self, cmd):
        ...
        if cmd_lower == "google":
            ...
            # Reafficher le prompt immediatement (le processus est en arriere-plan)
            ...
            try:
                ...
                if '&' not in command:
                    try:
                        ...
                        # La commande continue en arriere-plan
                        pass
            except Exception as e:
...
class MainScreen(Screen):
    ...
    def show_module_list(self):
        try:
            ...
            grid.clear_widgets()
            modules = [
                {"name": "Convertisseur", "letter": "Te", "glass_color": [0.63, 0.82, 1, 0.2]},
                {"name": "Note", "letter": "No", "glass_color": [1, 0.71, 0.76, 0.2]},
                {"name": "IA", "letter": "IA", "glass_color": [0.85, 0.71, 1, 0.2]},
                {"name": "Systeme", "letter": "Sm", "glass_color": [0.69, 0.88, 0.9, 0.2]}
            ]
            btn_size = dp(150)
...
# -------------------------------------------------------------------
# KV string (definition de l'interface graphique)
# -------------------------------------------------------------------
KV = """
